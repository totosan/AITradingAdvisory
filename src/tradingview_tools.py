"""
TradingView Chart Tools for AITradingAdvisory
...
<body>
    <div class="chart-header">
        <div>
            ...
            <div class="chart-info">Interval: {interval} | Generated: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")} | AITradingAdvisory Analysis</div>
        </div>
        <div class="toolbar">
...
<body>
    <div class="header">
        <div>
            ...
            <div class="info">Interval: {interval} | Generated: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")} | AITradingAdvisory AI</div>
        </div>
    </div>
...
<body>
    <div class="layout">
        ...
        <!-- Footer -->
        <div class="footer">
            <span>Generated: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")} | AITradingAdvisory AI Analysis</span>
