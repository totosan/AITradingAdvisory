...
charting with the AgenticTrades multi-agent system:
...
<body>
    ...
    <div class="footer">
        <p>Generated by AgenticTrades Crypto Analysis Platform | {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
...
<body>
    ...
    <div class="footer">
        <p>Generated by AgenticTrades AI | {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
