...
This is an **AITradingAdvisory multi-agent system** migrated from console to web application. The platform uses AutoGen's MagenticOne orchestrator pattern where specialized AI agents collaborate to analyze crypto markets.
